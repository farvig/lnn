...
<section class="banner-container" style="background-image: url(<?php echo get_template_directory_uri(); ?>/img/404.jpg);">
  <div class="banner__content">
    <h2 class="banner__title">Der er ikke noget at lære her...</h2>
    <a href="/" class="btn banner-cta">Få mig væk!</a>
  </div>
</section>
 <section class="posts-search">
 	<h2 class="section__title">Måske en søgning kan hjælpe?</h2>
...
<section class="popular-categories-container">
  <div class="center">
    <h2 class="section__title">Eller kig under en kategori</h2>
...
<section class="tag-list-container">
  <div class="center">
    <h2 class="section__title">Eller et specifikt nøgleord?</h2>
