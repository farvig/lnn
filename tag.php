        ...
        <article class="posts-list-item-container grid size-6 size-12--palm">
          ...
          <div class="grid-group">
            ...
            <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" title="Se profilen" class="posts-list-item__person grid size-2 size-4--palm">
        		...
        		if( $author_badge != ''){
				?>
					<img src="<?php $author_badge_thumbnail = wp_get_attachment_image_src($author_badge); echo $author_badge_thumbnail[0]; ?>" alt="<?php echo $author_badge['alt']; ?>" class="posts-list-item__person-portrait" />
				<?php }else{ ?>
